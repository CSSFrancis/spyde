...
**[⬇ Download SpyDE v0.3.1](https://github.com/CSSFrancis/spyde/releases/tag/v0.3.1)** — pick your platform:

| Platform | Download |
|----------|----------|
| **Windows** | [SpyDE-Setup-0.3.1.exe](https://github.com/CSSFrancis/spyde/releases/download/v0.3.1/SpyDE-Setup-0.3.1.exe) |
| **macOS** (Apple Silicon) | [SpyDE-0.3.1-arm64-mac.zip](https://github.com/CSSFrancis/spyde/releases/download/v0.3.1/SpyDE-0.3.1-arm64-mac.zip) |
| **Linux** | [SpyDE-0.3.1.AppImage](https://github.com/CSSFrancis/spyde/releases/download/v0.3.1/SpyDE-0.3.1.AppImage) |
