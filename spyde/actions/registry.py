...
STAGED_HANDLERS: dict[str, str] = {
    ...
    # Segment Particles (spyde/actions/particles_action.py) — plan B7.
    "seg_open":            "spyde.actions.particles_action.seg_open",
    "seg_close":           "spyde.actions.particles_action.seg_close",
    ...
    "movie_add_burnin":        "spyde.actions.report.movie.movie_add_burnin",
    "movie_add_insitu_overlay": "spyde.actions.report.movie.movie_add_insitu_overlay",
