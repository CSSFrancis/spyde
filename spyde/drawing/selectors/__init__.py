...
from spyde.drawing.selectors.selector2d import (
    RectangleSelector, CrosshairSelector, CircleSelector, AnnularSelector,
    LineProfileSelector, IntegratingSSelector2D,
)
